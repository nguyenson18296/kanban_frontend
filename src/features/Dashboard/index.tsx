...
const imgNotificationBell = 'https://www.figma.com/api/mcp/asset/27216c00-b468-4ee8-b67e-76714f952625';
const imgPlus = 'https://www.figma.com/api/mcp/asset/4abf972e-c3ff-4630-8ba1-e6b4ea1c0c93';
  ...
  return (
    <header className="sticky top-0 z-10 flex h-20 items-center justify-between border-b border-[#e2e8f0] bg-white/50 px-8 backdrop-blur-sm">
      ...
      <div className="flex items-center gap-4">
        {/* Notification bell */}
        <button className="relative flex h-10 w-10 items-center justify-center rounded-full border-none bg-transparent">
          <img src={imgNotificationBell} alt="Notifications" className="h-5 w-4" />
          <span className="absolute right-2.5 top-2 h-2 w-2 rounded-full border-2 border-white bg-[#e74008]" />
        </button>

        {/* Create Task button */}
        <button className="flex h-10 items-center gap-2 rounded-xl border-none bg-[#5a5cf2] px-5 text-sm font-semibold leading-5 text-white shadow-[0_10px_15px_-3px_rgba(90,92,242,0.2),0_4px_6px_-4px_rgba(90,92,242,0.2)] transition-colors hover:bg-[#4a4ce2]">
          <img src={imgPlus} alt="" className="h-2.5 w-2.5" />
          Create Task
        </button>
      </div>
    </header>
